...
//   title: z.string().min(10, { message: "El título debe tener al menos 10 caracteres" }).max(30, { message: "El título no puede tener más de 30 caracteres" }),
...
//   const validateForm = () => {
//     try {
//       // Convertir quantity a número para la validación
...
//         unit: formData.unit,
//         date: formData.date,
//         // No enviamos evidence por ahora, se implementaría con un servicio de almacenamiento
//       }
...
//         router.refresh() // Refrescar para actualizar los datos
//       }
...
//     const quantity = Number.parseFloat(formData.quantity)
//     if (isNaN(quantity) || quantity > 20) return 0
//     const pointsPerUnit = ACTIVITY_POINTS[formData.type as keyof typeof ACTIVITY_POINTS] || ACTIVITY_POINTS.OTHER
...
//                 Considera que:
//                 <p>
//                   Cantidad mínima de caracteres para el Título: 10 - máxima: 30.
//                 </p>
//                 <p>
//                   Cantidad mínima de caracteres para la Descripción: 10 - máxima: 100.
//                 </p>
//                 <p>
//                   Cantidad máxima de acuerdo al Tipo de actividad: 20. ejemplo: 20 árboles - 20 kg
//                 </p>
//               </CardDescription>
//             </CardHeader>
...
//                     <div
//                       key={type.value}
//                       className="flex items-center space-x-1 border rounded-lg p-3 hover:bg-muted/50 cursor-pointer sm:space-x-2"
//                     >
//                       <RadioGroupItem value={type.value} id={type.value} className="sr-only" />
//                       <Label htmlFor={type.value} className="flex items-center gap-2 cursor-pointer w-full">
//                         <div
//                           className={`flex h-8 w-8 items-center justify-center rounded-full ${formData.type === type.value
...
//                     Cantidad <span className="text-xs text-muted-foreground">(máx. 20)</span>
//                   </Label>
//                   <Input
//                     id="quantity"
//                     name="quantity"
...
//                     <span className="text-xs text-muted-foreground">Soporta imágenes y documentos (máx. 5MB)</span>
//                   </Label>
//                 </div>
...
//                     Puntos estimados: {calculateEstimatedPoints()} pts
//                   </p>
...
//                     {formData.type === "WATER_SAVING" &&
//                       `${ACTIVITY_POINTS.WATER_SAVING} pts por litro de agua ahorrado`}
//                     {formData.type === "ENERGY_SAVING" &&
//                       `${ACTIVITY_POINTS.ENERGY_SAVING} pts por kWh de energía ahorrado`}
//                     {formData.type === "COMPOSTING" &&
//                       `${ACTIVITY_POINTS.COMPOSTING} pts por kg de material compostado`}
//                     {formData.type === "EDUCATION" &&
//                       `${ACTIVITY_POINTS.EDUCATION} pts por hora de educación ambiental`}
        ...
        <Card>
          ...
          <form onSubmit={handleSubmit} ref={formRef}>
            <CardHeader>
              ...
              <CardDescription>
                Considera que:
                <p>Cantidad mínima de caracteres para el Título: 10 - máxima: 30.</p>
